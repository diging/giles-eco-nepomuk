package edu.asu.nepomuk.files.impl;
...
import edu.asu.nepomuk.core.DocumentAccess;
import edu.asu.nepomuk.core.DocumentType;
...
import edu.asu.nepomuk.files.IDocumentDatabaseClient;
import edu.asu.nepomuk.files.IFilesDatabaseClient;
import edu.asu.nepomuk.files.IFilesManager;
import edu.asu.nepomuk.files.IUploadDatabaseClient;
import edu.asu.nepomuk.service.IFileHandlerRegistry;
import edu.asu.nepomuk.service.IFileTypeHandler;
...
public class FilesManager implements IFilesManager {
        ...
        for (IFile file : files.keySet()) {
            ...
            try {
                ...
                statuses.add(new StorageStatus(file,
                        new NepomukFileStorageException(e), StorageStatus.FAILURE));
            }
        }
    ...
    public IFile getFileByPath(String path) {
        IFile file = new edu.asu.nepomuk.core.impl.File();
