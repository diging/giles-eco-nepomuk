...
public interface Properties {
    ...
    public final static String KAFKA_TOPIC_STORAGE_DELETE_REQUEST = "topic_delete_storage_request";
    public final static String KAFKA_TOPIC_STORAGE_DELETE_COMPLETE_REQUEST = "topic_delete_storage_request_complete";
