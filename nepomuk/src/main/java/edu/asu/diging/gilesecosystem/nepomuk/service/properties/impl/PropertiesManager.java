package edu.asu.diging.gilesecosystem.nepomuk.service.properties.impl;
...
import edu.asu.diging.gilesecosystem.nepomuk.exception.NepomukPropertiesStorageException;
...
public class PropertiesManager implements IPropertiesManager {
    ...
    @Override
    public void setProperty(String key, String value) throws NepomukPropertiesStorageException {
        properties.setProperty(key, value);
        saveProperties();
    }
    
    @Override
    public void updateProperties(Map<String, String> props) throws NepomukPropertiesStorageException {
    ...
    protected void saveProperties() throws NepomukPropertiesStorageException {
        try {
            persister.store(properties, customPropsResource.getOutputStream(), "Giles custom properties.");
        } catch (IOException e) {
            throw new NepomukPropertiesStorageException("Could not store properties.", e);
        }
    }
}
